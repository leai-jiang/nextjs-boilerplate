                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[48px]">
                    {coreBusinesses.map((business, index) => (
                        <div key={index} className="text-center p-[32px] rounded-lg hover:shadow-xl transition-shadow duration-300">
                            <div className="p-[16px] inline-block bg-cyan-100/50 rounded-full mb-[16px]">
                                {business.icon}
                            </div>
          ...
          <div className="container mx-auto px-[16px]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[48px] items-center">
              ...
              <div>
                ...
                <p className="text-[#141414] text-[16px] leading-[1.75] mb-[64px]">
